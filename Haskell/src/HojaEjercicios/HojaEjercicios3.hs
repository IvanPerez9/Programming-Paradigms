...
--calcularValor :: Expr -> Valor


{- 
Dudas: 

Acordarse de poner Constructor de tipo siempre con los data menos cuando son enum

Ejercicio B4 con coordenadas, y el anterior. Sin declarar "Punto"
